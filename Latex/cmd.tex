...
% Using equation numbers in align environment
\newcommand\numberthis{\addtocounter{equation}{1}\tag{\theequation}}

% Cancel to 
\usepackage[makeroom]{cancel}

% Text over equality sign 
...
%%%% LIMITING DISTRIBUTION NOTATION %%%%
\newcommand{\sigxx}{{\sigma_{\hat{\pi}_x}^x}}
\newcommand{\sigxy}{{\sigma_{\hat{\pi}_x}^{x \to y}}}
\newcommand{\sigyy}{{\sigma_{\pi_y}^y}}


%%%% STATIONARY DISTRIBUTION NOTATION %%%%
\newcommand{\rhoxx}{{\rho_{\hat{\pi}_x}^x}}
\newcommand{\rhoxy}{{\rho_{\hat{\pi}_x}^{x \to y}}}
\newcommand{\rhoyy}{{\rho_{\pi_y}^y}}
...
\newcommand{\IRL}{\mathrm{IRL}}
\newcommand{\LA}{\mathcal{L}\mathcal{A}}
\newcommand{\tgrad}{\G_{\pi}}
\newcommand{\tgradstar}{\G_{\pi^{k}}}
